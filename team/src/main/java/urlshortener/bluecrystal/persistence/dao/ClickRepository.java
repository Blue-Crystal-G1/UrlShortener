...
public interface ClickRepository extends JpaRepository<Click,Long> {
	...
	List<Click> findByHashAndCreatedBetween(String hash, LocalDateTime start, LocalDateTime end);

	List<Click> findByCreatedBetween(LocalDateTime start, LocalDateTime end);
}
