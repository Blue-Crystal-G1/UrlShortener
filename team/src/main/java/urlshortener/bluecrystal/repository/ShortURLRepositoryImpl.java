...
public class ShortURLRepositoryImpl implements ShortURLRepository {
	...
	private static final RowMapper<ShortURL> rowMapper = (rs, rowNum) -> new ShortURL(rs.getString("hash"), rs.getString("target"),
            null, rs.getString("sponsor"), rs.getDate("created").toLocalDate(),
	...
	public ShortURL save(ShortURL su) {
		try {
			jdbc.update("INSERT INTO shorturl VALUES (?,?,?,?,?,?,?,?,?)",
                    ...
                    Date.valueOf(su.getCreated()), su.getOwner(), su.getMode(), su.getSafe(),
	...
	public void update(ShortURL su) {
		try {
			jdbc.update(
					...
					su.getTarget(), su.getSponsor(), Date.valueOf(su.getCreated()),
